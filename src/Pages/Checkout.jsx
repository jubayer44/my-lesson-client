...
const Checkout = () => {
    return (
        ...
        //     <div className='w-1/2'>
        //         <img className='w-full' src="https://www.eschoolnews.com/files/2020/09/digital-learning-tools.jpg" alt="" />
        //     </div>
        //     <div className='w-1/2'>
                ...
                <div className="flex flex-col md:w-full">
                    ...
                    <form className="justify-center w-full mx-auto" method="post">
                        <div className="">
                            ...
                            <div className="mt-4">
                                <button
                                    className="w-full btn btn-outline btn-primary">Process</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div className="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                    <div className="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div className="flex p-4 mt-4">
                            <h2 className="text-xl font-bold">Search Engine Marketing (SEM)</h2>
                        </div>
                        <div
                        ...
                        <div
                            className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Shipping Tax<span className="ml-2">$00</span></div>
                        <div
                            className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Total<span className="ml-2">$40.00</span></div>
                    </div>
                </div>
            </div>
        </div>
