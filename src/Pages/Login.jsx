    ...
    <div className="flex min- overflow-hidden">
        <div className="flex flex-col my-20 rounded-md justify-center shadow-lg mx-auto  flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20   xl:px-24">
            <div className="w-full max-w-xl mx-auto lg:w-96">
                <div>
                    <h2 className="mt-6 text-3xl font-extrabold text-neutral-600 text-center">Login</h2>
                </div>
                ...
                <div className="mt-8">
                    <div className="mt-6">
                        ...
                        <div>
                            ...
                            <p className='mt-4'><small>Don't Have an Account? Please <Link to='/register' className='text-blue-500'>Register</Link></small></p>
                        </div>
                    </div>
                </div>
            </div>
